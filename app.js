...
function renderMenu(cat, searchQuery = '') {
  ...
  if (items.length === 0) {
    menuGridEl.innerHTML = `
      <div class="search-empty-state" style="grid-column: 1/-1; text-align: center; padding: 40px; color: var(--text-muted, #777);">
...
function bindEvents() {
  ...
  catTabsEl.addEventListener('click', e => {
    ...
    // Track active category and apply with search value
